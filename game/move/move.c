...
{
	if (game->worldMap[(int)(game->pos_x + game->dir.x
			* P_SPEED)][(int)(game->pos_y)] == '0')
		game->pos_x += game->dir.x * P_SPEED;
	if (game->worldMap[(int)(game->pos_x)][(int)(game->pos_y + game->dir.y
			* P_SPEED)] == '0')
...
{
	if (game->worldMap[(int)(game->pos_x - game->plane.x
			* P_SPEED)][(int)(game->pos_y)] == '0')
		game->pos_x -= game->plane.x * P_SPEED;
	if (game->worldMap[(int)(game->pos_x)][(int)(game->pos_y - game->plane.y
			* P_SPEED)] == '0')
