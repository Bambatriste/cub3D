...
typedef struct s_game
{
	...
	t_vector dir;// orientation du joueur vers le plan (ex : -1;0) ici regarde a gauche
	t_vector plane;// vecteur du plan (toujours a 90degres avec dir) (ex : 0;0.66) perpendiculaire lorsque le produit scalaire des deux vecteurs == 0 : ici (0 * -1) + ( 0 * 0.66) == 0
	t_params *params;
	t_window *window;
	t_ray *ray;
	t_textures *tex;
...
//char *get_path(char *buffer, int *type, t_game *game);
